...
**Goal:** Update the dashboard to display dynamic stats, an active event banner, and a recent activity feed fetched from the backend.

**Architecture:** Fetch data from `/reports/summary` and `/reports/activity` endpoints using the established API utility. Update components to be data-driven.

**Tech Stack:** React, Lucide Icons, Shadcn UI Components.

---

### Task 1: Update StatsGrid Component

**Files:**
- Modify: `src/components/dashboard/StatsGrid.jsx`

- [ ] **Step 1: Update StatsGrid to accept stats prop**
...
```bash
git add src/components/dashboard/StatsGrid.jsx
git commit -m "feat(dashboard): update StatsGrid to accept dynamic stats"
```

---

### Task 2: Implement Dynamic DashboardPage

**Files:**
- Modify: `src/pages/DashboardPage.jsx`

- [ ] **Step 1: Add data fetching and sub-components to DashboardPage**
...
git commit -m "feat(dashboard): implement live stats and activity feed"
```
