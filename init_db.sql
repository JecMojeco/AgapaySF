-- 1. Run this first to create the database (if not done via GUI)
-- Note: You must be connected to the 'postgres' database to run this.
CREATE DATABASE agapaysf;

-- 2. After creating the database, CONNECT to 'agapaysf' and then run the rest:
